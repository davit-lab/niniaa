...
async function seed() {
  ...
  await setDoc(doc(db, "site_settings", "global"), {
    ...
    about_text: 'ნინო ხიხაძე — დამოუკიდებელი ფოტოგრაფი თბილისიდან. 2024 წლიდან ვქმნი ვიზუალურ ისტორიებს, რომლებიც წამიერ ემოციას მარადიულ კადრად აქცევს.',
